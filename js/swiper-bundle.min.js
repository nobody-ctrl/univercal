...
!(function (e, t) {
  ...
  var h = (function (e) {
    ...
    function i(t) {
      var a, i, s;
      return (
        (a = e.call.apply(e, [this].concat(t)) || this, i = (function (e) {
          if (void 0 === e) {
  ...
  var g,
    ...
    b = {
      addClass: function () {
        for (var e = arguments.length, t = new Array(e), a = 0; a < e; a += 1) {
          t[a] = arguments[a];
        }
        var i = v(
          t.map(function (e) {
        ...
        for (var l = i.split(" "), o = 0; o < l.length; o += 1) {
          for (var d = l[o], p = 0; p < this.length; p += 1) {
            ...
            if ((!s && u.dom7Listeners
                ? (c = u.dom7Listeners[d])
                : s && u.dom7LiveListeners && (c = u.dom7LiveListeners[d]), c && c.length)) {
      ...
      trigger: function () {
        for (var e = l(), t = arguments.length, a = new Array(t), i = 0; i < t; i += 1) {
          a[i] = arguments[i];
        }
    ...
    if ((o.originalEvent && (o = o.originalEvent), i.isTouched)) {
      if (!i.isTouchEvent || "touchmove" === o.type) {
        ...
        if (!a.allowTouchMove) {
          return (
            (a.allowClick = !1, void (
              (i.isTouched && (S(n, { startX: p, startY: u, currentX: p, currentY: u }), i.touchStartTime = x()))
            ))
          );
        }
        if (i.isTouchEvent && s.touchReleaseOnEdges && !s.loop) {
          if (a.isVertical()) {
            if ((u < n.startY && a.translate <= a.maxTranslate()) ||
            (u > n.startY && a.translate >= a.minTranslate())) {
              return (i.isTouched = !1, void (i.isMoved = !1));
            }
          } else if ((p < n.startX && a.translate <= a.maxTranslate()) ||
        ...
        if (
          ...
          if (
            ...
            if ((i.isScrolling && a.emit("touchMoveOpposite", o), void 0 === i.startMoving &&
              ...
              if (
                ...
                if (!i.allowThresholdMove) {
                  return (
                    (i.allowThresholdMove = !0, n.startX = n.currentX, n.startY = n.currentY, i.currentTranslate = i.startTranslate, void (n.diff = a.isHorizontal()
                      ? n.currentX - n.startX
                      : n.currentY - n.startY))
                  );
                }
  ...
  function D(e) {
    ...
    if ((t.allowClick &&
        ...
        c < 300 &&
          ...
          t.emit("doubleTap doubleClick", d)), a.lastClickTime = x(), E(function () {
    ...
    if ((a.isTouched = !1, a.isMoved = !1, a.startMoving = !1, p = i.followFinger
        ? r
          ? t.translate
          : -t.translate
        : -a.currentTranslate, !i.cssMode)) {
      if (i.freeMode) {
        if (p < -t.minTranslate()) {
  ...
  var Y = {
    ...
    V = {
      ...
      eventsEmitter: {
        ...
        once: function (e, t, a) {
          ...
          function s() {
            ...
            for (var a = arguments.length, r = new Array(a), n = 0; n < a; n += 1) {
              r[n] = arguments[n];
            }
            t.apply(i, r);
          }
        ...
        emit: function () {
          ...
          for (var s = arguments.length, r = new Array(s), n = 0; n < s; n += 1) {
            r[n] = arguments[n];
          }
      ...
      update: {
        ...
        updateAutoHeight: function (e) {
          ...
          if (("number" == typeof e
              ? a.setTransition(e)
              : !0 === e && a.setTransition(a.params.speed), "auto" !== a.params.slidesPerView && a.params.slidesPerView > 1)) {
      ...
      slide: {
        slideTo: function (e, t, a, i) {
          ...
          if ((m = n > u ? "next" : n < u ? "prev" : "reset", (c && -g === r.translate) || (!c && g === r.translate))) {
            return (
              (r.updateActiveIndex(n), l.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), "slide" !== l.effect && r.setTranslate(g), "reset" !== m && (r.transitionStart(a, m), r.transitionEnd(a, m)), !1)
            );
          }
          if (l.cssMode) {
            var x,
        ...
        attachEvents: function () {
          ...
          if (!o.touch && o.pointerEvents) {
            ...
            if (o.touch) {
              var p = !(
                ("touchstart" !== i.start ||
                !o.passiveListener || !a.passiveListeners)
              ) && { passive: !0, capture: !1 };
    ...
    R = (function () {
      function t() {
        for (var e, a, i = arguments.length, s = new Array(i), r = 0; r < i; r += 1) {
          s[r] = arguments[r];
        }
        ...
        if ((e = o[0])) {
          ...
          var p, u, c;
          return (
            (e.swiper = n, e && e.shadowRoot && e.shadowRoot.querySelector
              ? ((p = m(
      ...
      return (
        (r.emitContainerClasses = function () {
          ...
          return (
            (e || (e = "horizontal" === i ? "vertical" : "horizontal"), e === i ||
      ...
      renderSlide: function (e, t) {
        ...
        return (
          (s.attr("data-swiper-slide-index") ||
            s.attr("data-swiper-slide-index", t), i.cache && (a.virtual.cache[t] = s), s)
        );
      },
      appendSlide: function (e) {
        var t = this;
      ...
      handle: function (e) {
        ...
        if (
          ...
          if (
            ...
            var m = !1;
            if (t.$el.parents("." + t.params.slideClass).length > 0 &&
  ...
  var U = {
      ...
      normalize: function (e) {
        var t = 0,
          ...
          s = 0;
        return (
          ("detail" in e && (a = e.detail), "wheelDelta" in e && (a = -e.wheelDelta / 120), "wheelDeltaY" in e && (a = -e.wheelDeltaY / 120), "wheelDeltaX" in e && (t = -e.wheelDeltaX / 120), "axis" in e && e.axis === e.HORIZONTAL_AXIS && ((t = a), (a = 0)), i = 10 * t, s = 10 * a, "deltaY" in e && (s = e.deltaY), "deltaX" in e && (i = e.deltaX), e.shiftKey && !i && ((i = s), (s = 0)), (i || s) &&
            e.deltaMode &&
            (1 === e.deltaMode
              ? ((i *= 40), (s *= 40))
              : ((i *= 800), (s *= 800))), i && !t && (t = i < 1 ? -1 : 1), s && !a && (a = s < 1 ? -1 : 1), { spinX: t, spinY: a, pixelX: i, pixelY: s })
        );
      },
      ...
      handle: function (e) {
        ...
        var s = a.$el;
        if (("container" !== a.params.mousewheel.eventsTarget &&
            (s = m(a.params.mousewheel.eventsTarget)), !a.mouseEntered && !s[0].contains(t.target) && !i.releaseOnEdges)) {
          return !0;
        }
        ...
        if (
          ...
          if (!u) {
            ...
            if ((u || a.emit("scroll", t), a.params.autoplay &&
              a.params.autoplayDisableOnInteraction &&
              a.autoplay.stop(), c === a.minTranslate() || c === a.maxTranslate())) {
              return !0;
            }
          }
        } else {
          ...
          if ((T.push(b), C
            ...
            : a.mousewheel.animateSlider(b), a.mousewheel.releaseScroll(b))) {
            return !0;
          }
        }
      ...
      animateSlider: function (e) {
        ...
        return (
          ...
          !(
            (this.params.mousewheel.thresholdTime && x() - t.mousewheel.lastScrollTime <
      ...
      enable: function () {
        ...
        return (
          ("container" !== e.params.mousewheel.eventsTarget &&
            (a = m(e.params.mousewheel.eventsTarget)), a.on("mouseenter", e.mousewheel.handleMouseEnter), a.on("mouseleave", e.mousewheel.handleMouseLeave), a.on(t, e.mousewheel.handle), e.mousewheel.enabled = !0, !0)
        );
      },
      disable: function () {
        var e = this,
        ...
        return (
          ("container" !== e.params.mousewheel.eventsTarget &&
            (a = m(e.params.mousewheel.eventsTarget)), a.off(t, e.mousewheel.handle), e.mousewheel.enabled = !1, !0)
        );
      },
    },
    K = {
    ...
    ee = {
      ...
      enable: function () {
        ...
        if (!a.enabled) {
          ...
          var i = !(
              ...
              !t.passiveListener || !e.params.passiveListeners)
            ) && { passive: !0, capture: !1 },
      ...
      disable: function () {
        ...
        if (t.enabled) {
          ...
          var i = !(
              ("touchstart" !== e.touchEvents.start ||
              !a.passiveListener || !e.params.passiveListeners)
            ) && { passive: !0, capture: !1 },
    ...
    ae = {
      LinearSpline: function (e, t) {
        ...
        return (
          (this.x = e, this.y = t, this.lastIndex = e.length - 1, this.interpolate = function (e) {
            return e
              ? ((n = l(this.x, e)),
                (r = n - 1),
    ...
    re = {
      ...
      setHash: function () {
        ...
        if (e.hashNavigation.initialized && e.params.hashNavigation.enabled) {
          if (e.params.hashNavigation.replaceState &&
          t.history &&
      ...
      update: function (e) {
        ...
        if (a) {
          ...
          if ((t.params.slidesPerView > 1 &&
              ...
              (u = t.params.slidesPerView), t.params.thumbs.multipleActiveThumbs || (u = 1), u = Math.floor(u), a.slides.removeClass(c), a.params.loop || (a.params.virtual && a.params.virtual.enabled))) {
            for (var h = 0; h < u; h += 1) {
              a.$wrapperEl
                .children(
